...
def on_ticks(ws, ticks):
    ...
    if stage1 == 0:
        if first == "stage_1":
            ...
            candle1.open, candle1.high, candle1.low, candle1.close = (copy.deepcopy(ticks["last_price"])) * 4
            first = "stage_2"
            return
        elif first == "stage_2":
            ...
            if ticks["last_trade_time"] < next_candle_start_time:
                ...
                candle2 = Candle()
                candle2.open, candle2.high, candle2.low, candle2.close = (copy.deepcopy(ticks["last_price"])) * 4
                stage1 = 2
                first = "stage_3"
                current_candle_start_time = ticks["last_trade_time"]
                next_candle_start_time = current_candle_start_time + timedelta(minutes=candle_duration)
